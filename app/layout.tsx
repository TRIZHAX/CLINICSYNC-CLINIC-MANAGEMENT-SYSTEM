...
export const metadata:Metadata={title:{default:"ClinicSync",template:"%s · ClinicSync"},description:"School Clinic Management System for student health profiles, clinic visits, medicine inventory, and reports",applicationName:"ClinicSync",robots:{index:false,follow:false}};
