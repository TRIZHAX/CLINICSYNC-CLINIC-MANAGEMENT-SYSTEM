...
import { BookOpen, LayoutDashboard, UsersRound, Stethoscope, CalendarDays, ClipboardPlus, Pill, BarChart3, Bell, ShieldCheck, Settings, Menu, X, Search, UserCog } from "lucide-react";
...
const all = [
  ...
  {href:"/patients",label:"Students",icon:UsersRound,roles:["ADMIN","DOCTOR","NURSE","RECEPTIONIST"]},
  ...
  {href:"/study-scope",label:"Study Scope",icon:BookOpen,roles:["ADMIN","DOCTOR","NURSE","RECEPTIONIST"]},
